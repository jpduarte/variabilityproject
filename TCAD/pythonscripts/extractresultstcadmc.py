...
#find SS with the current at given vgi wrt current*level
  ...
  return SS
######################
root_dir = '/users/jpduarte/research/variabilityproject/TCAD/data/v8'
...
montecarloresultsall = open('montecarloresultsallfiletcadmc', 'w')
stringtoprint = 'Ioff'+' '+'Ion'+' '+'Wt'+' '+'Lg'+' '+'Hfin'+' '+'tox'+' '+'WbR'+' '+'WbL' +' '+'Nfin'+' '+'vd'+' '+'Vth'+' gmax'+' SS'+' filename'+'\n'
montecarloresultsall.write(stringtoprint)

montecarloresultsallvdlin = open('montecarloresultsallfilevdlintcadmc', 'w')
montecarloresultsallvdlin.write(stringtoprint)
montecarloresultsallvdmed = open('montecarloresultsallfilevdmedtcadmc', 'w')
montecarloresultsallvdmed.write(stringtoprint)
montecarloresultsallvdsat = open('montecarloresultsallfilevdsattcadmc', 'w')
