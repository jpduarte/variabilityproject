...
#find SS with the current at given vgi wrt current*level
  ...
  return SS
######################
root_dir = '/users/jpduarte/research/variabilityproject/netlist_modelcards/mchspice10nmv3'
...
montecarloresultsall = open('montecarloresultsallfilemchspice10nmv3', 'w')
stringtoprint = 'Ioff'+' '+'Ion'+' '+'Wt'+' '+'Lg'+' '+'Hfin'+' '+'tox'+' '+'WbR'+' '+'WbL' +' '+'Nfin'+' '+'vd'+' '+'Vth'+' gmax'+' SS'+' filename'+'\n'
montecarloresultsall.write(stringtoprint)

montecarloresultsallvdlin = open('montecarloresultsallfilevdlinmchspice10nmv3', 'w')
montecarloresultsallvdlin.write(stringtoprint)
montecarloresultsallvdmed = open('montecarloresultsallfilevdmedmchspice10nmv3', 'w')
montecarloresultsallvdmed.write(stringtoprint)
montecarloresultsallvdsat = open('montecarloresultsallfilevdsatmchspice10nmv3', 'w')
