...
def unified_IMG_model(Vgf,Vgb,Vch,q,k,T,eo,eins,ech,Eg,Nc,Nv,vt,ni,phi_substrate,phi_gatef,phi_gateb,Tsi,tins,tinsbox,Hfin):
  ...
  Cins1 = Cins*qmatvth2/qmatvth2new #unified_charge_model_inverse(qmatvth2,Vth2-
  Cins2 = 2*Cins-Cins1
...
for Vgb in Vgb_array:
  ...
  #qmbaux = -(vt*Cins1/Weff)*unified_charge_model(Vgf-deltaVth1,0,q,k,T,eo,eins,ech,Eg,Nc,Nv,vt,ni,phi_substrate,phi_gateb,1.5,Cins,Ach,Weff,Nch)
  #qmfaux = -(vt*Cins2/Weff)*unified_charge_model(Vgf,0,q,k,T,eo,eins,ech,Eg,Nc,Nv,vt,ni,phi_substrate,phi_gatef,1.5,Cins,Ach,Weff,Nch)
  qmbaux,qmfaux =  unified_IMG_model(Vgf,Vgb,0,q,k,T,eo,eins,ech,Eg,Nc,Nv,vt,ni,phi_substrate,phi_gatef,phi_gateb,Tsi,tins,tinsbox,Hfin)
  qmb.append(qmbaux)
  qmf.append(qmfaux)
...
print "Vth1 final: " + str(Vth1)  
print "Vth2: " + str(Vth2)
print "qm at Vth2: " + str(-qmatvth2*Cins*vt/Weff)
print "qm at Vth2 new2: " + str(-(vt*Cins1/Weff)*unified_charge_model(Vth2-deltaVth1,0,q,k,T,eo,eins,ech,Eg,Nc,Nv,vt,ni,phi_substrate,phi_gateb,alpha_MI,Cins,Ach,Weff,Nch))
print "Cins1/Cins: " + str(Cins1/Cins)
print "Cins2/Cins: " + str(Cins2/Cins)"""
