...
modelcardpath = "/users/jpduarte/research/variabilityproject/netlist_modelcards/templateshspice/modelcard-109-geo4template_mc_pmos.nmos"#modelcard-109template.nmos"
vgssample = 50
vdssample = 2
...
for L in Lg:
  ...
  #parse results
  filenameaux = parsehspice.parsehspicev1(wheretosimpath,filenameoutput,vds,str(L))
  print filenameaux

figurenumber=1
for namefile in filenameaux:
  plotgeneral.plotinverter(wheretosimpath,namefile,'gateOuterVoltage', 'drainTotalCurrent',figurenumber,1)
